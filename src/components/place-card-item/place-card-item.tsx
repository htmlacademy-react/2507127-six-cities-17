...
function PlaceCardItem({offer, cardClass, onHandleActiveOfferChange}: PlaceCardItemProps): JSX.Element{
  ...
  return (
    ...
    >
      {isPremium && <Mark markClass={GeneralCategories.PlaceCard}/>}
      ...
      <div className={`${isFavorite ? 'favorites__card-info' : ''}place-card__info`}>
        <div className='place-card__price-wrapper'>
          ...
          <BookmarkButton isFavorite={isFavorite} bookmarkClass={GeneralCategories.PlaceCard}/>
        </div>
        <Rating ratingClass={GeneralCategories.PlaceCard} rating={rating}/>
